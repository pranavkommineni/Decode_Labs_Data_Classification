...
The objective of this project is to create a scalable and reusable classification framework capable of evaluating multiple machine learning models and identifying the best-performing classifier for a given dataset.This evaluates the data sets and give a clear output for the given data sets.this scans the given datasets and gives us the accurate outputs.
